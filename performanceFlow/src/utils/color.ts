...
/** Alias: original isValidHex was a type guard — preserve that signature. */
export const isValidHex = (hex: string | null | undefined): hex is string =>
    typeof hex === "string" && isHexColor(hex);

/** Alias: original name for resourceColor in this module. */
export const getResourceColor = resourceColor;
