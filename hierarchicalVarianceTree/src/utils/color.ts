...
import { RESOURCE_COLORS, STATUS_COLORS, PASTEL_COLORS, VIVID_COLORS, SLATE, SEMANTIC } from "../constants";
...
/** Get the variance colour: favourable, unfavourable, or neutral. */
export function varianceColor(variance: number, favourableColor: string, unfavourableColor: string, neutralColor: string): string {
...
export function defaultVarianceColor(variance: number): string {
    return varianceColor(variance, SEMANTIC.emerald500, SEMANTIC.red500, SLATE[400]);
}
